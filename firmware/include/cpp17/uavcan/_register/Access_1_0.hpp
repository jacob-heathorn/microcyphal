...
// Source file   : 384.Access.1.0.dsdl
// Is deprecated : no
// Fixed port-ID : 384
...
struct Request_1_0 final
{
    ...
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr const char* FullNameAndVersion() { return "uavcan.register.Access.Request.1.0"; }
...
struct Response_1_0 final
{
    ...
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr const char* FullNameAndVersion() { return "uavcan.register.Access.Response.1.0"; }

...
struct Request_1_0 final
{
    ...
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr const char* FullNameAndVersion() { return "uavcan.register.List.Request.1.0"; }
...
struct Response_1_0 final
{
    ...
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr const char* FullNameAndVersion() { return "uavcan.register.List.Response.1.0"; }

...
// Source file   : 430.GetInfo.1.0.dsdl
// Is deprecated : no
// Fixed port-ID : 430
...
struct Request_1_0 final
{
    ...
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr const char* FullNameAndVersion() { return "uavcan.node.GetInfo.Request.1.0"; }
...
struct Response_1_0 final
{
    ...
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr const char* FullNameAndVersion() { return "uavcan.node.GetInfo.Response.1.0"; }
        ...
        struct ArrayCapacity
        {
            ...
            static constexpr std::size_t unique_id = 16UL;
            static constexpr std::size_t name = 50UL;
            static constexpr std::size_t software_image_crc = 1UL;
            static constexpr std::size_t certificate_of_authenticity = 222UL;
        };
    };

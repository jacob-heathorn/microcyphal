...
// Source file:   435.ExecuteCommand.1.1.dsdl
// Is deprecated: yes
// Fixed port-ID: 435
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/jacob/.cyphal/uavcan/node/435.ExecuteCommand.1.1.dsdl is trying to use a serialization library that was compiled with "
              "different language options. This is dangerous and therefore not allowed." );
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_OMIT_FLOAT_SERIALIZATION_SUPPORT == 0,
              "/home/jacob/.cyphal/uavcan/node/435.ExecuteCommand.1.1.dsdl is trying to use a serialization library that was compiled with "
              "different language options. This is dangerous and therefore not allowed." );
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_OMIT_SERIALIZATION_SUPPORT == 0,
              "/home/jacob/.cyphal/uavcan/node/435.ExecuteCommand.1.1.dsdl is trying to use a serialization library that was compiled with "
              "different language options. This is dangerous and therefore not allowed." );
...
static inline void uavcan_node_ExecuteCommand_Request_1_1_initialize_(uavcan_node_ExecuteCommand_Request_1_1* const out_obj)
{
    ...
    {
        size_t size_bytes = 0;
        const int8_t err = uavcan_node_ExecuteCommand_Request_1_1_deserialize_(out_obj, NULL, &size_bytes);
...
static inline void uavcan_node_ExecuteCommand_Response_1_1_initialize_(uavcan_node_ExecuteCommand_Response_1_1* const out_obj)
{
    ...
    {
        size_t size_bytes = 0;
        const int8_t err = uavcan_node_ExecuteCommand_Response_1_1_deserialize_(out_obj, NULL, &size_bytes);

...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/jacob/.cyphal/uavcan/node/Mode.1.0.dsdl is trying to use a serialization library that was compiled with "
...
static inline void uavcan_node_Mode_1_0_initialize_(uavcan_node_Mode_1_0* const out_obj)
{
    ...
    {
        size_t size_bytes = 0;
        const int8_t err = uavcan_node_Mode_1_0_deserialize_(out_obj, NULL, &size_bytes);

...
// Source file   : Unstructured.1.0.dsdl
// Is deprecated : no
// Fixed port-ID : None
...
struct Unstructured_1_0 final
{
    ...
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr const char* FullNameAndVersion() { return "uavcan.primitive.Unstructured.1.0"; }
        ...
        struct ArrayCapacity
        {
            ...
            static constexpr std::size_t value = 256UL;
        };
    };
